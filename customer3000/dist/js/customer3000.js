/*! Customer3000 3.6.22 | https://www.getuikit.com | (c) 2014 - 2021 YOOtheme | MIT License */

(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
    typeof define === 'function' && define.amd ? define('Customer3000', factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Customer3000 = factory());
    ...
    */
    ...
    function globalAPI (Customer3000) {

        var DATA = Customer3000.data;

        Customer3000.use = function (plugin) {
        ...
        Customer3000.mixin = function (mixin, component) {
            component = (isString(component) ? Customer3000.component(component) : component) || this;
            component.options = mergeOptions(component.options, mixin);
        };

        Customer3000.extend = function (options) {
        ...
        Customer3000.update = function (element, e) {
        ...
        var container;
        Object.defineProperty(Customer3000, 'container', {
    ...
    function hooksAPI (Customer3000) {

        Customer3000.prototype._callHook = function (hook) {
            var this$1 = this;
        ...
        Customer3000.prototype._callConnected = function () {
        ...
        Customer3000.prototype._callDisconnected = function () {
        ...
        Customer3000.prototype._callUpdate = function (e) {
            var this$1 = this;
        ...
        Customer3000.prototype._callWatches = function () {
            var this$1 = this;
    ...
    function stateAPI (Customer3000) {

        var uid = 0;

        Customer3000.prototype._init = function (options) {
        ...
        Customer3000.prototype._initData = function () {
        ...
        Customer3000.prototype._initMethods = function () {
        ...
        Customer3000.prototype._initComputeds = function () {
        ...
        Customer3000.prototype._initProps = function (props) {
        ...
        Customer3000.prototype._initEvents = function () {
            var this$1 = this;
        ...
        Customer3000.prototype._unbindEvents = function () {
            this._events.forEach(function (unbind) { return unbind(); });
            delete this._events;
        };

        Customer3000.prototype._initObservers = function () {
            this._observers = [
        ...
        Customer3000.prototype._disconnectObservers = function () {
    ...
    function instanceAPI (Customer3000) {

        var DATA = Customer3000.data;

        Customer3000.prototype.$create = function (component, element, data) {
            return Customer3000[component](element, data);
        };

        Customer3000.prototype.$mount = function (el) {
        ...
        Customer3000.prototype.$reset = function () {
            this._callDisconnected();
            this._callConnected();
        };

        Customer3000.prototype.$destroy = function (removeEl) {
        ...
        Customer3000.prototype.$emit = function (e) {
            this._callUpdate(e);
        };

        Customer3000.prototype.$update = function (element, e) {
            if ( element === void 0 ) element = this.$el;

            Customer3000.update(element, e);
        };

        Customer3000.prototype.$getComponent = Customer3000.getComponent;

        var componentName = memoize(function (name) { return Customer3000.prefix + hyphenate(name); });
        Object.defineProperties(Customer3000.prototype, {

            $container: Object.getOwnPropertyDescriptor(Customer3000, 'container'),
    ...
    function componentAPI (Customer3000) {

        var DATA = Customer3000.data;

        var components = {};

        Customer3000.component = function (name, options) {
            ...
            if (!options) {
                ...
                if (isPlainObject(components[name])) {
                    components[name] = Customer3000.extend(components[name]);
                }
            ...
            Customer3000[name] = function (element, data) {
                var i = arguments.length, argsArray = Array(i);
                while ( i-- ) argsArray[i] = arguments[i];


                var component = Customer3000.component(name);
                ...
                function init(element) {
                    ...
                    var instance = Customer3000.getComponent(element, name);
            ...
            if (opt.install) {
                opt.install(Customer3000, opt, name);
            }

            if (Customer3000._initialized && !opt.functional) {
                fastdom.read(function () { return Customer3000[name](("[uk-" + id + "],[data-uk-" + id + "]")); });
            }

            return components[name] = isPlainObject(options) ? opt : options;
        };

        Customer3000.getComponents = function (element) { return element && element[DATA] || {}; };
        Customer3000.getComponent = function (element, name) { return Customer3000.getComponents(element)[name]; };

        Customer3000.connect = function (node) {
        ...
        Customer3000.disconnect = function (node) {
            for (var name in node[DATA]) {
    ...
    var Customer3000 = function (options) {
        this._init(options);
    };

    Customer3000.util = util;
    Customer3000.data = '__uikit__';
    Customer3000.prefix = 'uk-';
    Customer3000.options = {};
    Customer3000.version = '3.6.22';

    globalAPI(Customer3000);
    hooksAPI(Customer3000);
    stateAPI(Customer3000);
    componentAPI(Customer3000);
    instanceAPI(Customer3000);

    function Core (Customer3000) {
        ...
        var handleResize = function () {
            ...
            Customer3000.update(null, 'resize');
        };
        ...
        on(window, 'scroll', function (e) {
            ...
            Customer3000.update(null, e.type);
    ...
    function boot (Customer3000) {

        var connect = Customer3000.connect;
        var disconnect = Customer3000.disconnect;
        ...
        fastdom.read(function () {
            ...
            Customer3000._initialized = true;
        });
        ...
        function applyAttributeMutation(ref) {
            ...
            if (!name || !(name in Customer3000)) {
                return;
            }

            if (hasAttr(target, attributeName)) {
                Customer3000[name](target);
                return;
            }

            var component = Customer3000.getComponent(target, name);
    ...
    var parsed = {};
    function install$3(Customer3000) {
        Customer3000.icon.add = function (name, svg) {
            var obj;
            ...
            if (Customer3000._initialized) {
                apply$1(document.body, function (el) { return each(Customer3000.getComponents(el), function (cmp) {
    ...
    // register components
    each(components$1, function (component, name) { return Customer3000.component(name, component); }
    );

    // core functionality
    Customer3000.use(Core);
    ...
    function fade(action, target, duration, stagger) {
        ...
        var enterFn = wrapIndexFn(function () {
            ...
            // Ensure Customer3000 updates have propagated
    ...
    function install$1(Customer3000, Lightbox) {

        if (!Customer3000.lightboxPanel) {
            Customer3000.component('lightboxPanel', LightboxPanel);
        }

        assign(
            Lightbox.props,
            Customer3000.component('lightboxPanel').options.props
        );
    ...
    function install(Customer3000) {
        Customer3000.notification.closeAll = function (group, immediate) {
            apply$1(document.body, function (el) {
                var notification = Customer3000.getComponent(el, 'notification');
    ...
    each(components, function (component, name) { return Customer3000.component(name, component); }
    );
