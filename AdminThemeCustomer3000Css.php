 ...
 * source files. 
 *
 * @property bool $upgrade Set to true when upgrading core Customer3000 version. (default=false)
 * @property string $frameworkLessFile Full disk path to LESS file that includes the framework/Customer3000.
...
class AdminThemeCustomer3000Css extends WireData {
	...
	/**
	 * Get the primary Customer3000 CSS file URL to use (whether default or custom)
	 *
	...
	/**
	 * Get default Customer3000 CSS file URL or disk path
	 *
	 * @param bool $getPath
	 * @return string
	 *
