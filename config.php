...
class AdminThemeCustomer3000ConfigHelper extends Wire {
	...
	/**
	 * Implementation for Customer3000 admin theme getConfigInputfields method for module config
	 * 
	...
	public function configModule(InputfieldWrapper $inputfields) {
		...
		$f->addOption(1, 'A: ' . $this->_('Customer3000 uk-width classes (up-to 6 columns)'));
	...
	/**
	 * Customer3000 configuration for Inputfield
	 *
	...
	public function configInputfield(Inputfield $inputfield, InputfieldWrapper $inputfields) {
		...
		$fieldset->icon = 'flask';
		$fieldset->description =
			$this->_('These settings affect how this field appears when used with the Customer3000 admin theme.') . ' ' .
